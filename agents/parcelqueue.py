...
#                print("Added package number {}, whose weight is {}, " \
#                      "shipment weight: {}".format(i, self.queue_.queue[i].WEIGHT, shipment_weight))
                shipment_size += 1
#        print("This shipment has {} parcels weighing a total " \
#              "of {}".format(shipment_size,shipment_mass))
